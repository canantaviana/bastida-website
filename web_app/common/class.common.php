...
function wrap_pre($string, $add_header_html=true) {
	...
	$style = 'tab-size:2;white-space:pre-wrap;overflow:auto;min-width:500px;font-family:monospace;color:#4B5D5E;font-size:0.8em;background-color:rgb(201, 212, 241);border-radius:5px;padding:10px;position:relative;z-index:1';
