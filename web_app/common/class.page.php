...
class page {
	...
	*/
	public function get_page_data_combi() {
		...
		// TEMPORAL FAKES
			// FAKE temporal template_map record inject template
				// $this->data_combi[0]->result[] = (function() {

				// 	$template = new stdClass();
				// 		$template->table	= "template_map";
				// 		$template->name		= "faqs";
				// 		$template->data		= '{"id":"faqs","template":"faqs","table":"ts_web_yacimientos","detail":[{"type":"title","colname":"titulo"},{"type":"abstract","colname":"entradilla"},{"type":"body","colname":"cuerpo"}]}';

				// 	return $template;
				// })();

			// FAKE ts_web_yacimientos data record
				// $this->data_combi[1]->result[] = (function() {

				// 	$record = new stdClass();
				// 		$record->table					= 'ts_web_yacimientos';
				// 		$record->section_id				= 50;
				// 		$record->term_id				= 'mupreva2564_50';
				// 		$record->term					= 'FAQS';
				// 		$record->web_path				= 'faqs';
				// 		$record->titulo					= 'FAQS';
				// 		$record->parent					= 'mupreva2564_2';
				// 		$record->childrens				= null;
				// 		$record->template_name			= 'faqs';
				// 		$record->entradilla				= null;
				// 		$record->cuerpo					= null;
				// 		$record->norder					= 0;
				// 		$record->imagen					= null;
				// 		$record->actividades			= null;
				// 		$record->excavaciones			= null;
				// 		$record->catalogo				= null;
				// 		$record->yacimientos			= null;
				// 		$record->contextos				= null;
				// 		$record->espacios				= null;
				// 		$record->temas					= null;
				// 		$record->publicaciones			= null;
				// 		$record->publicaciones_externas	= null;
				// 		$record->galeria_digital		= null;
				// 		$record->galeria_ephemera		= null;
				// 		$record->galeria_video			= null;
				// 		$record->galeria_audio			= null;
			...
			// debug
				...
				// dump($template, ' template ++ '.to_string());
				// dump($record, ' record ++ '.to_string());
				// dump($this->data_combi[1], ' this->data_combi[0] ++ '.to_string());
...
//var_dump($template_items);
	...
	*/
	public function get_menu_tree_plain( $term_id=WEB_MENU_PARENT, $exclude=[] ) {
		...
		// (!) MUPREVA USES EMPTY PATHS TO CREATE MENU ANCHORS LIKE 'SABER MÀS'
