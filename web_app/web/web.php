...
// include config file
	// $site_safe_path = dirname(dirname(dirname(__FILE__))) . '/tpl/config/config.php';
	...
	switch (WEB_TEMPLATE_MAP_DEFAULT_SOURCE) {
		...
		default:
			...
			// menu_all records (from ts_web)
				...
				// dump($page->data_combi[0], ' page->data_combi ++ menu_all '.to_string());
				// dump($term_data, '$term_data ++ '.to_string());
