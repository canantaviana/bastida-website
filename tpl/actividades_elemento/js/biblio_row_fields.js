...
var biblio_row_fields = {
	...
	author : function() {
		...
		if (dedalo_logged===true) {
			...
			const link = common.create_dom_element({
				...
				href			: '/dedalo/core/page/?tipo=rsc205&id=' + biblio_object.section_id,
				parent			: line
			})
	...
	render_row_bibliography : function(row){
		...
		// ref_publications_authors: "MartÃ­nez Chico David"
		// ref_publications_date: "2016"
		// ref_publications_editor: null
		// ref_publications_magazine: "Gaceta NumismÃ¡tica"
		// ref_publications_place: null
		// ref_publications_title: "Sextante inÃ©dito para la ceca sevillana de Lastigi"
	...
	render_cite_this : function(cite_data){
		...
		// lang: "lg-spa"
		// publication_data :{
		// 	editor: "Universitat de ValÃ¨ncia - Museu de PrehistÃ²ria de ValÃ¨ncia"
		// other_people_data: "[\"229\"]"
		// other_people_full_names: "Pere Pau RipollÃ¨s Alegre | Manuel Gozalbes FernÃ¡ndez de Palencia"
		// other_people_full_roles: "ed"
		// other_people_name: "[\"Pere Pau\",\"Manuel\"]"
		// other_people_role: "[\"ed\"]"
		// other_people_surname: "[\"RipollÃ¨s Alegre\",\"Gozalbes FernÃ¡ndez de Palencia\"]"
		// 	publication_date: "2022-00-00 00:00:00"
		// 	table: "publications"
		// 	title: "Moneda IbÃ©rica"
		// 	typology_name: "PÃ¡gina web"
		...
		// 	authorship_roles: "IntroducciÃ³n | OrdenaciÃ³n emisiones"
		// 	authorship_surnames: "CerdÃ  Insa | RipollÃ¨s Alegre"
		// }
