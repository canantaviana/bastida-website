...
This repository contains the source code for the official **[bastidaalcusses.org](https://bastidaalcusses.org)** website, scheduled for launch in **2026**.
...
1. **Clone the repository**
   ```bash
   git clone https://github.com/mupreva/bastida-website.git
   ```
...
**La Bastida de les Alcusses**, offering:
